...
export default {
  ...
  data() {
    return {
      copyright: '&copy; 2022 Jannata Bali Resort & Spa',
      jamsekarang: null,
      formatjam: null,
      suhu: 23,
      formatsuhu: '°C',
      address:
        'Jl. Rsi Markandya, Br. Bangkiang Sidem Desa Keliki, Tegalalang – Gianyar, Bali 80561 Indonesia',
      contacts: [
        {
          text: 'Mobile',
          label: '+62 852 37998077',
          link: 'tel:+6285237998077',
        },
        {
          text: 'Phone',
          label: '+62 361 4792778',
          link: 'tel:+623614792778',
        },
        {
          text: 'Fax',
          label: '+62 361 4792778',
        ...
        {
          text: 'Email',
          label: 'reservation@jannataresort.com',
          link: 'mailto:reservation@jannataresort.com',
        },
      ],
    }
  },
  ...
  methods: {
    getRealtime() {
      ...
      this.$el.querySelector('.time').innerHTML = strTime
      this.$el.querySelector('.formattime').innerHTML = ampm
    },
  },
}
</script>
